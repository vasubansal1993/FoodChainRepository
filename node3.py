...
class Blockchain:
    ...
    def __init__(self):
        ...
        # set the ports of the nodes connected to peersnodes
        self.node_list = [5000,5002]
    ...
    def start_threads(self):
        #The thread will start recieving the messages from peers to update the chain
        Thread(target=self.receive_message).start()

    # implementation.receive_message(self)

    # implementation.send_chain(self)

    # implementation.start_threads(self)
